...
**本稿でいう「戦略的エラー許容」とは、"エラーを放置すること"ではなく、"開発継続を止めずに段階的に解消する戦略" を指します。**
...
- **動作確認環境**: Node.js v20 / TypeScript v5.4 / @typescript-eslint v7系 / Husky v9
- **安全フェンス**:
...
# turboがない場合は単純に変更差分を検出
node scripts/check-affected.mjs || git diff --name-only origin/main
```
...
**本記事は Node.js 20 / TypeScript 5.4 / Husky 9 で検証済み**
